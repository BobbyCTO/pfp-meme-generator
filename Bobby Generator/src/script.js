...
canvas.setWidth(500); // Set default width
canvas.setHeight(500); // Set default height

// URLs for images
const mainImageUrl = 'https://raw.githubusercontent.com/traderkendo/pfpgen/main/bobby.jpg';
const bobbyImageUrl = 'https://raw.githubusercontent.com/traderkendo/pfpgen/main/bobbybg.png';
const bobbyHeadImageUrl = 'https://raw.githubusercontent.com/traderkendo/pfpgen/main/images/bobby-removebg-preview-fotor-bg-remover-20240707135640.png';
const watermarkImageUrl = 'https://raw.githubusercontent.com/traderkendo/pfpgen/main/watermarkbobbyhead.png';

// Function to resize the canvas based on screen width
function resizeCanvas() {
    ...
    if (screenWidth < 430) {
        ...
        canvas.setWidth(500); // Example default width for larger screens
        canvas.setHeight(500); // Example default height for larger screens
    }
